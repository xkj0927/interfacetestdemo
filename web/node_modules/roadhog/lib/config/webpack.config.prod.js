...
exports.default = function (args, appBuild, config, paths) {
  ...
  // Support hash
  var name = config.hash ? '[name].[chunkhash]' : '[name]';
  ...
  var finalWebpackConfig = _extends({
    ...
    plugins: [].concat(_toConsumableArray(watch ? [] : [new _webpack2.default.optimize.OccurrenceOrderPlugin(), new _webpack2.default.optimize.DedupePlugin()]), [new _extractTextWebpackPlugin2.default(name + '.css')], _toConsumableArray((0, _common.getCommonPlugins)({
      config: config,
      paths: paths,
      appBuild: appBuild,
      NODE_ENV: NODE_ENV
