...
public class DataService {
  ...
  public List<Object[]> getTestCaseData(long projectId) {
    ...
    sql.append(
        "SELECT pit.test_case_name caseName, pin.interface_url url, pin.interface_type type,")
        .append(
            "           pit.param_case paramters, pit.expect_result expectResult, pit.expect_status expectStatus")
